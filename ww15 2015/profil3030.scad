...
linear_extrude(file = "30mmslottake2.dxf", layer = "tslotrounded",
...
translate([-15,-15,0])union(){
linear_extrude(file = "30mmslottake2.dxf", layer = "tslotrounded2",
  height = h, center = true, convexity = 10);
}
}
//tslotmodel2();
...
linear_extrude(file = "30mmslottake2.dxf", layer = "nutplace",
  height = h, center = true, convexity = 10);
}
}
//nutplace();
...
linear_extrude(file = "30mmslottake2.dxf", layer = "nut1",
  height = h, center = true, convexity = 10);
}
}
//nut1();
...
module nut2(h=10){
translate([0,0,h/2])union(){
linear_extrude(file = "30mmslottake2.dxf", layer = "nut2",
  height = h, center = true, convexity = 10);
}
}
//nut2();
...
module nut3(h=10){
translate([0,0,h/2])union(){
linear_extrude(file = "30mmslottake2.dxf", layer = "nut3",
  height = h, center = true, convexity = 10);
}
}
//nut3();
...
linear_extrude(file = "30mmslottake2.dxf", layer = "nut4",
  height = h, center = true, convexity = 10);
}
}
//nut4();
...
union(){
translate([5,-1,-5])cube([5,25,10]);
translate([-10,-1,-5])cube([5,25,10]);
}
}
}
//nutinsert();
